  ...
  return (
    <AnimatedPage>
      ...
      <section className="relative min-h-[calc(100vh-80px)] flex items-center justify-center text-center overflow-hidden p-4">
        ...
        {/* HUD Brackets */}
        <div className="absolute inset-8 md:inset-16 lg:inset-24 border-2 border-brand-blue/20 rounded-lg pointer-events-none">
        ...
        <div className="relative z-10">
          ...
          <h2 className="font-mono text-lg md:text-2xl text-brand-blue animate-glow h-8">
      ...
      <section className="py-20 px-4 sm:px-8 bg-brand-dark">
