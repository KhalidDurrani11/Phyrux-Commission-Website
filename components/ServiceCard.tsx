...
const ServiceCard: React.FC<{ service: Service }> = ({ service }) => {
    ...
    return (
        <motion.div
            ...
            className="relative p-8 h-full bg-white dark:bg-brand-gray border border-gray-200 dark:border-brand-gray/50 rounded-lg shadow-lg overflow-hidden group"
        ...
        >
            ...
            <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold uppercase tracking-wide text-brand-dark dark:text-brand-light">{service.title}</h3>
                <p className="mt-2 text-brand-dark/70 dark:text-brand-light/70">{service.description}</p>
            </div>
        </motion.div>
    );
};
